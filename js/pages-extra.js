...
function renderTerms() {
  ...
  return renderLegalPage(
    ...
    <ol>
      <li>「전자상거래 등에서의 소비자보호에 관한 법률」에 따라 재화 등을 공급받은 날부터 7일 이내 청약철회가 가능합니다. 단, 신선식품 등 법령상 청약철회가 제한되는 재화는 예외로 합니다.</li>
      <li>다음의 경우 교환·반품이 제한될 수 있습니다: 이용자의 책임 있는 사유로 재화가 멸실·훼손된 경우, 포장을 개봉하여 재판매가 곤란한 신선식품의 경우, 시간 경과로 재판매가 어려운 경우.</li>
      <li>신선식품의 품질 이상(파손, 부패, 오배송 등)은 수령 후 24시간 이내 사진과 함께 고객센터로 접수해 주시면 확인 후 교환·환불 처리합니다.</li>
